...
extern uint8_t buff_SALIDA;
uint8_t GetInputSENSORSALIDA(void){
	static uint8_t buff_before = 0x00;

	if ( buff_SALIDA == 0x01 && buff_before == 0x00 ){
		buff_before = 0x01;
		return (1);
	}
	else if ( buff_SALIDA == 0x01 && buff_before == 0x01 )
		return (0);
	else if ( buff_SALIDA == 0x00 && buff_before == 0x01 ){
		buff_before = 0x00;
		return (0);
	}
	else
...
extern uint8_t buff_ENTRADA;
uint8_t GetInputSENSORENTRADA(void){
	static uint8_t buff_before = 0x00;

	if ( buff_ENTRADA == 0x01 && buff_before == 0x00 ){
		buff_before = 0x01;
		return (1);
	}
	else if ( buff_ENTRADA == 0x01 && buff_before == 0x01 )
		return (0);
	else if ( buff_ENTRADA == 0x00 && buff_before == 0x01 ){
		buff_before = 0x00;
		return (0);
	}
	else
